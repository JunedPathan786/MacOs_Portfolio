const navMenus = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        id: "show-window-list",
        label: "Show Window List",
        action: "showWindowList",
      },
    ],
  },
  {
...
const ABOUT_LOCATION = {
  ...
  children: [
    ...
    },
    {
      ...
      description: [
        "Hey! I’m Juned 👋, A FullStack developer specializing in MERN stack development and full-stack application engineering.",
